...
- Public data attributes are namespaced by feature (`data-flyout-*`, `data-dialog-*`, `data-tooltip-*`). Do not expose shared implementation names such as `surface` unless they are meant as a stable author concept.
