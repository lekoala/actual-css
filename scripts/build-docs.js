...
// bundles the site depends on. assets/ holds the site's own files: docs.css
// and docs.js are edited directly, search-index.js is regenerated on each
// build; nothing is copied from src/ or dist/.
const REQUIRED_DIST = [
  join(DIST, "actual.js"),
...
function writePages(navigation, rendered, themes) {
  for (const page of navigation.pages) {
    ...
    const html = renderPage({
      ...
      docsCss: repoAsset(from, join(ASSETS, "docs.css")),
      actualJs: repoAsset(from, join(DIST, "actual.js")),
      docsJs: repoAsset(from, join(ASSETS, "docs.js")),
...
This directory contains the generated documentation pages plus the site's own
assets (docs.css, docs.js), which are edited directly.

Do not edit the generated HTML pages or assets/search-index.js directly. Edit
\`docs/pages/**/*.md\`, \`docs/navigation.json\`, \`scripts/docs/**\`,
\`scripts/templates/docs-page.html\`, \`docs/site/assets/docs.css\`, or
\`docs/site/assets/docs.js\`, then regenerate.
`,
  );
}
